package com.theprofessorplate.filter;
...
// Apply this filter to protected pages/resources
@WebFilter(urlPatterns = {"/profile/*", "/order/*", "/checkout/*"})
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (isLoggedIn) {
            ...
            RedirectionUtil.redirectToLogin(httpRequest, httpResponse);
        }
    }
}
