...
<body>
    ...
    <section id="gallery" class="gallery-grid">
        <div class="gallery-item" data-category="mains">
            <img src="Steak.jpg" alt="Steak dish">
        ...
        <div class="gallery-item" data-category="mains">
            <img src="Vegsteak.jpg" alt="Steak with vegetables">
            <div class="item-overlay">
        ...
        <div class="gallery-item" data-category="drinks">
            <img src="Drink.jpg" alt="Cocktail">
            <div class="item-overlay">
                <h3>Cocktail</h3>
                <p>House specialty</p>
            </div>
        ...
        <div class="gallery-item" data-category="mains">
            <img src="Salmon.jpg" alt="Salmon dish">
            <div class="item-overlay">
                <h3>Salmon</h3>
                <p>Fresh catch</p>
            </div>
        ...
        <div class="gallery-item" data-category="experience">
            <img src="Food.jpg" alt="Cooking class">
            <div class="item-overlay">
                <h3>Cooking Class</h3>
                <p>Learn with us</p>
            </div>
        ...
        <div class="gallery-item" data-category="drinks">
            <img src="Drinks.jpg" alt="Beverages">
            <div class="item-overlay">
                <h3>Beverages</h3>
    ...
    <div class="feature-section">
        ...
        <div class="feature-image">
            <img src="Burger.jpg" alt="Burger with fries">
        </div>
    </div>
